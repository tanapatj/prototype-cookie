...
export as namespace ConsentManager
...
declare namespace ConsentManager {
     ...
     */
    function run(configOptions: ConsentManagerConfig): Promise<void>
     ...
     */
    function getConfig(): ConsentManagerConfig
     ...
     * @returns value of the specified field
     */
    function getConfig<Field extends keyof ConsentManagerConfig>(field: Field): ConsentManagerConfig[Field]
