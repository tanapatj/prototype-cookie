...
- **Type**:
  ```javascript
  function({
      cookie: {} // same as ConsentManager.getCookie()
  }): void
  ```
...
- **Type**:
  ```javascript
  function({
      cookie: {} // same value as ConsentManager.getCookie()
  }): void
  ```
...
::: warning
If you've installed ConsentManager in a subdomain, and the cookie you're trying to erase is in the main domain, you'll have to specify your main domain in the `domain` field of the `Cookie` object.
:::
