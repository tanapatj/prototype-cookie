...
export const setCookie = (useRemainingExpirationTime) => {
    ...
    debug('ConsentManager [SET_COOKIE]: ' + name + ':', globalObj._state._savedCookieContent);
};
...
export const eraseCookiesHelper = (cookies, customPath, customDomain) => {
    ...
    for (const cookieName of cookies) {
        ...
        debug('ConsentManager [AUTOCLEAR]: deleting cookie: "' + cookieName + '" path: "' + path + '" domain:', domain);
    }
};
