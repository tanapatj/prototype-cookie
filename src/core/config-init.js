...
export const setConfig = (userConfig) => {
    ...
    debug('ConsentManager [CONFIG]: configuration:', userConfig);
    debug('ConsentManager [CONFIG]: autoClearCookies:', config.autoClearCookies);
    debug('ConsentManager [CONFIG]: revision enabled:', state._revisionEnabled);
    debug('ConsentManager [CONFIG]: manageScriptTags:', config.manageScriptTags);
